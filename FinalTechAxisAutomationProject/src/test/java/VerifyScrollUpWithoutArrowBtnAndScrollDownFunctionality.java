...
public class VerifyScrollUpWithoutArrowBtnAndScrollDownFunctionality {
    WebDriver driver;
    @BeforeClass
    public void SetUp() {
    ...
    @Test
    public void ScrollUpWithoutUsingArrowBtn() throws InterruptedException {
        ...
        WebElement scrollHeader= driver.findElement(By.cssSelector("header"));
        JavascriptExecutor js1 = (JavascriptExecutor) driver;
        js1.executeScript("arguments[0].scrollIntoView(true);", scrollHeader);
        Thread.sleep(1000);
